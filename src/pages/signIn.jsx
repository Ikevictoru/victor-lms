        ...
        <p className="text-center">Enter your username and password to continue.</p>
         ...
         <label className="p-2 mt-2 block">Email</label>
            ...
            className='w-full pl-10 p-2 border rounded-lg '/>
             ...
             <div>
              <p className='mt-4 text-sm'><Link to ='/ForgotPassword' className='text-blue-600 hover:underline'>Forgot password</Link></p>
            </div>

             <br />
            <button className='w-full text-white py-1 bg-blue-700 border rounded-lg '>Sign In</button>
            ...
            <div>
              <p className='mt-4 text-sm text-center'>Don't have an account?{" "}  <Link to ='/signUp' className='text-blue-600 hover:underline'> sign up</Link></p>
            </div>
